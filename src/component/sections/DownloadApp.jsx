...
const DownloadApp = () => {
    return (
        <div className="container mx-auto px-4">
            <div className="relative flex flex-col md:flex-row h-[500px] md:h-[400px] my-16 bg-[#6f40ff] rounded-3xl overflow-hidden">
                <div className="w-full md:w-3/4 flex pl-10 md:pl-20 items-start justify-center flex-col relative top-5 md:top-0 z-20">
                    ...
                    >
                        <button className="flex gap-2 mt-5 bg-[#02123f] text-white px-6 py-3 rounded-full text-lg font-bold hover:bg-white hover:text-black transition-all duration-300">
                            <Download />Download Now
                        </button>
                    </a>
                </div>
                <div className="relative w-full left-[0%] bottom-[-45px] md:bottom-[30%] rotate-1">
